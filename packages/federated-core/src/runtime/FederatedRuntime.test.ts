...
let lifecycleMethodCallCount: Record<FederatedLifecyleMethods, number> = {
  bootstrap: 0,
  mount: 0,
  unmount: 0,
  update: 0,
    ...
    describe('set modules', () => {
      it('should set modules to new module map', () => {
        ...
        const newMap: Map<string, FederatedModule> = new Map([
          ['scope/name', { scope: 'scope', name: 'name', type: 'app-module' }],
        ])
  ...
  describe('methods', () => {
    ...
    describe('fetchImportMapContent', () => {
      it('should fetch import map content', async () => {
        ...
        const result = await federatedRuntime.fetchImportMapContent(modulePath)
    ...
    describe('setModuleState', () => {
      it('should set module state', () => {
        ...
        federatedRuntime.setModuleState(module, FederatedModuleStatuses.LOADED)
    ...
    describe('getModuleUrl', () => {
      it('should call fetchImportMapContent', async () => {
        ...
        const importMapContent = {
          imports: {
            'scope:name': 'https://cdn.vodafone.co.uk/federated/scope/name.js',
          },
        }
        const fetchPromise = Promise.resolve({
          json: () => Promise.resolve(importMapContent),
    ...
    describe('loadModule', () => {
      ...
      it('should call registerModule if module is not registered or module status is not set', async () => {
        ...
        const registerModuleSpy = jest.spyOn(federatedRuntime, 'registerModule')
    ...
    describe('reroute', () => {
      ...
      it('should set module state to NOT_LOADED when activeWhenPaths does not match the pathname but no unmount function defined', async () => {
        ...
        expect(federatedRuntime.modules.get('scope:module-1')?.status).toEqual(
          FederatedModuleStatuses.NOT_LOADED
        )
      })
    ...
    describe('bootstrap', () => {
      it('should set bootstrapped to true', () => {
        expect(federatedRuntime.bootstrapped).toBe(false)
        federatedRuntime.bootstrap()
        expect(federatedRuntime.bootstrapped).toBe(true)
      })

      it('should call bootstrap on each module', () => {
        const module: FederatedModule = {
          scope: 'scope',
          name: 'name',
          type: 'app-module',
      ...
      it('should register PopStateEvent listener', () => {
      ...
      it('should trigger popstate event on new popstate event', () => {
        federatedRuntime.bootstrap()
      ...
      it('should call ensureSystemJs method', () => {
      ...
      it('should call addImportMapOverridesUi method', () => {
      ...
      it('should emit correct default events', () => {
        federatedRuntime.bootstrap()
        expect(dispatchedEventCount).toEqual({
          [FederatedEvents.RUNTIME_BEFORE_BOOTSTRAP]: 1,
          [FederatedEvents.SYSTEMJS_LOADED]: 1,
      ...
      it('should emit correct events when using native modules', () => {
        federatedRuntime.useNativeModules = true
        federatedRuntime.bootstrap()
        expect(dispatchedEventCount).toEqual({
          [FederatedEvents.RUNTIME_BEFORE_BOOTSTRAP]: 1,
      ...
      it('should emit correct events when using import map overrides', () => {
        federatedRuntime.importMapOverridesEnabled = true
        federatedRuntime.bootstrap()
      ...
      it('should emit correct events for all modules when bootstrapping', () => {
        const module1: FederatedModule = {
          scope: 'test-scope',
          name: 'test-module-1',
          type: 'app-module',
