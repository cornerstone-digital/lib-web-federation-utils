...
import { LogsInitConfiguration as BrowserLogConfig } from '@datadog/browser-logs/cjs/domain/configuration'

import { BrowserLogOptions, LoggerInstance, LoggerLevels, LogLevelOptions } from './browser-logger.types'
...
class BrowserLogger {
  ...
  protected service: string = 'federated-core'
  ...
  constructor(service: string, logLevel: LogLevelOptions, options: BrowserLogOptions) {
  ...
  protected log(level: LoggerLevels, message: string | object, componentName = '', logContext: object = {}) {
