...
```typescript jsx
import { eventService, FederatedEventKeys, FederatedEvents } from '@vf/federated-core'

eventService.register<FederatedEventKeys>(FederatedEvents.RUNTIME_BOOTSTRAPPED, (event) => {
...
type CustomEventsMap =
  | EventData<CustomEvents.TestEvent, { id: number }>
